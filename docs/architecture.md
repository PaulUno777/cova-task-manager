...
- Spring Boot application starts with **H2** (default/tests), **MySQL** (local Docker Compose), or a managed MySQL (Aiven, in production) profile same code, only datasource config differs.
